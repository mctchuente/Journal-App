...
public class MainActivity extends AppCompatActivity implements JournalAdapter.ItemClickListener {
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int swipeDir) {
                AppExecutors.getInstance().diskIO().execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        List<JournalEntry> diaries = mAdapter.getDiaries();
                        mDb.journalDao().deleteTask(diaries.get(position));
                    }
                });
            }
    ...
    private void setupViewModel() {
        ...
        viewModel.getDiaries().observe(this, new Observer<List<JournalEntry>>() {
            @Override
            public void onChanged(@Nullable List<JournalEntry> diaryEntries) {
                Log.d(TAG, "Updating list of tasks from LiveData in ViewModel");
                mAdapter.setDiaries(diaryEntries);
            }
        });
    }
    ...
    public void onItemClickListener(int itemId) {
        ...
        intent.putExtra(DetailDiaryActivity.EXTRA_DIARY_ID, itemId);
